...
export const MagicLinkEmail = {
  subject: 'JD Suite — sign in link',
  text: (link: string) =>
    `Hi,

Here is your sign-in link for JD Suite:
...
<div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 540px; margin: 0 auto; padding: 24px; background:#FAF7F2; color:#1A1A1A;">
  ...
  <p style="font-size: 14px; line-height: 1.6;">
    Click the button below to sign in to JD Suite. This link expires in 15 minutes.
  </p>
  <p style="margin: 28px 0;">
    <a href="${link}" style="display: inline-block; background: #1A1A1A; color: #fff; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-size: 14px; font-weight: 500;">Sign in →</a>
  </p>
